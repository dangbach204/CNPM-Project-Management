...
export default function StudentDashboard() {
  ...
  const enrolledProjects = mockProjects.filter((p) => p.enrolledStudents.includes(user?.id || ""))
  ...
  return (
    <div className="p-8 space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">Theo dõi đề tài và bài nộp của bạn</p>
      </div>
          ...
          <div className="space-y-4">
            {enrolledProjects.length === 0 ? (
              <div className="text-center py-8">
                <p className="text-muted-foreground mb-4">Bạn chưa tham gia đề tài nào</p>
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground mt-2">
                      Hạn chót: {new Date(project.endDate).toLocaleDateString("vi-VN")}
                    </p>
                  </div>
          ...
          <div className="space-y-4">
            {mySubmissions.length === 0 ? (
              ...
              mySubmissions.map((submission) => {
                const grade = myGrades.find((g) => g.submissionId === submission.id)
                return (
