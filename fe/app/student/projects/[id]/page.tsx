...
export default function ProjectDetailPage() {
  ...
  const isEnrolled = project.enrolledStudents.includes(user.id.toString())
  const studentSubmissions = mockSubmissions.filter((s) => s.projectId === projectId && s.studentId === user.id.toString())
