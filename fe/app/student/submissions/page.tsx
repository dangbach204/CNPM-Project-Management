...
export default function StudentSubmissionsPage() {
  ...
  const mySubmissions = mockSubmissions.filter((s) => s.studentId === user.id.toString())
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="p-8 space-y-8">
            <div>
              ...
              <p className="text-muted-foreground mt-2">Theo dõi tất cả bài nộp và điểm số</p>
            </div>
            ...
            {mySubmissions.length === 0 ? (
              <Card>
                <CardContent className="pt-12 pb-12 text-center">
                  ...
                  <p className="text-muted-foreground mb-4">Bạn chưa nộp bài nào</p>
                </CardContent>
              </Card>
            ) : (
                          ...
                          <div className="flex-1">
                            ...
                            {grade && (
                              <div className="bg-muted p-4 rounded-lg">
                                <p className="text-sm font-medium mb-2">Nhận xét từ giáo viên:</p>
