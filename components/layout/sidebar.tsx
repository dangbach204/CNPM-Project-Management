...
import { LayoutDashboard, BookOpen, Users, Settings, LogOut, FileText, BarChart3 } from "lucide-react"
  ...
  const getMenuItems = () => {
    ...
    if (user.role === "student") {
      return [
        ...
        { href: "/student/submissions", label: "Bài nộp của tôi", icon: FileText },
        { href: "/settings", label: "Cài đặt", icon: Settings },
      ]
    }
